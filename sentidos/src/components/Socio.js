    ...
    <div className="socio-dashboard-container">
      ...
      {!socioData.active && (
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ color: 'red', fontWeight: 'bold', fontSize: '18px', marginBottom: '20px' }}>
              Estás inhabilitado para usar las funciones del sistema.
            </p>
      ...
      {!socioData.active && (
        <div style={{
          ...
          <p style={{ color: 'red', fontWeight: 'bold', fontSize: '18px', margin: '0 0 10px 0' }}>
            Estás inactivo. Contacta con soporte por favor.
          </p>
          <button
            onClick={sendWhatsAppMessage}
      ...
      <div className="cards-container">
        <div className="card">
          <div className="card-header card-header-orange">
            ...
            Estado:
            <strong className={socioData.active ? 'activo' : 'inactivo'}>
              {socioData.active ? 'Activo' : 'Inactivo'}
            </strong>
            <p>
              <strong>Rol:</strong> {socioData.role}
            </p>
          </div>
            ...
            {isEditing ? (
              ...
              <>
                <p>
                  ...
                  {socioData.numeroSocio || "No disponible"}
                </p>
                <p>
                ...
                <p>
                  <strong>Provincia:</strong> {socioData.provincia || "No disponible"}
                </p>
                <p>
        ...
        <div className="card cuota-status-card">
